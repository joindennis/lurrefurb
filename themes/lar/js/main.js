...
$('div#pgwModal').click(function() {
	$('div#pgwModal').fadeOut(200);
});
	
	
$('.openModal2').click(function(e) {
 
var new_target = '#modalContent_'+$(this).data('id');
...
$('img.popup_design').click(function() {
 
	$('div.new_popup_1').css('display','block');
		$('#overlay_popup').css('display','block');
});

$('#overlay_popup, div.new_popup_1').click(function() {
		 
	$('div.new_popup_1').css('display','none');
...
$('img.popup_budget').click(function() {
	$('div.new_popup_2').css('display','block');
		$('#overlay_popup').css('display','block');
});

$('#overlay_popup, div.new_popup_2').click(function() {
	$('div.new_popup_2').css('display','none');
	$('#overlay_popup').css('display','none');
});
...
$('img.popup_managment').click(function() {
	$('div.new_popup_3').css('display','block');
		$('#overlay_popup').css('display','block');
});

$('#overlay_popup, div.new_popup_3').click(function() {
	$('div.new_popup_3').css('display','none');
	$('#overlay_popup').css('display','none');
});
...
slides 					:  	[			// Slideshow Images
								{image : 'wp-content/themes/lar/images/slider/slide1.min.jpg'},
								{image : 'wp-content/themes/lar/images/slider/slide2.min.jpg'},  
								{image : 'wp-content/themes/lar/images/slider/slide3.min.jpg'},
								{image : 'wp-content/themes/lar/images/slider/slide4.min.jpg'},  
								{image : 'wp-content/themes/lar/images/slider/slide5.min.jpg'}
							]
});	
...
//Isotope    
	...
	jQuery('ul li.active.has-sub:odd').css({
		'backgroundColor':'#fff',
		'color':'#888'	 
	 
		});
		
	jQuery('ul li.active.has-sub a:odd').css('color','#888');	
		
		
		
		
	
		jQuery('ul li.active.has-sub:even').css({
